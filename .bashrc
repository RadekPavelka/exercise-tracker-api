...
# off by default to not distract the users: the focus in a terminal window
...
# If this is an xterm set the title to users@host:dir
case "$TERM" in
xterm*|rxvt*)
...
# set PATH so it includes users's private bin directories
